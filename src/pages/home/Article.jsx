...
const Article = () => {
    return (
        <div>
            <section class="bg-[url(https://i.ibb.co/VVBnMkm/pexels-mudassir-ali-2680270.jpg)] dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      ...
      <div class="grid gap-8 lg:grid-cols-2">
          <article class="p-6 bg-[url(https://i.ibb.co/VVBnMkm/pexels-mudassir-ali-2680270.jpg)] rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
